const STORAGE_TOKEN = 'LZVZO625MJH4GSFN0DMNCQLK9WCD6NZ7CNHB8NLZ';
 ...
 * @param {*} index - You are looking for the index of an object = true. For everything else false
 * @param {*} yoursearchResult - The information you are looking for. (color, contact, firstname, lastname, email,...). If the index is searched, just enter a placeholder here.
 * @param {*} keyword - The keyword you use to search for the information. (an e-mail address, a first name, a surname, ...)
 * @param {*} searchFilter - The searchFilter is related to the keyword. if you search with an email address of a contact, the search filter must be email.
 * @param {*} searchPath - The place where to search. There are only 4 possibilities. (categories, contacts, tasks, users)
